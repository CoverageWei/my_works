...
*********************************************************************************************************
统计 57即机构 的总体 线上学习时长 + 直播时长；

select d1.provider_id, 
    d2.online_learn_duration as last_year_duration,
    d3.online_learn_duration as current_duration,
    if(d2.online_learn_duration is null, 
      d3.online_learn_duration, 
      if(cast((d3.online_learn_duration - d2.online_learn_duration) as bigint) < 0, 
        d3.online_learn_duration, 
        cast((d3.online_learn_duration - d2.online_learn_duration) as bigint))) as 2017_year_duration
from
(select id as provider_id, provider_name from qyy_dbload_online.s2_virtual_provider where day="2017-10-21" 
    and id in (400000000029002,400000000008007,400000000030003,400000000030004,400000000042003,400000000043004,400000000052009,
        400000000054003,400000000055001,400000000056001,400000000062002,400000000070001,400000000071001,400000000073001,400000000073002,
        ...
        400000000135002,400000000137001,400000000052001,400000000140001,400000000149001,400000000128001,400000000199009,400000000200009,
        400000000214007,400000000233006,400000000232001,400000000230013,400000000239013,400000000237025,400000000235027,400000000237077,
        400000000235094,400000000250004) ) d1
left outer join 
(
    select provider_id,
          sum(cast(t1.duration as bigint)) as online_learn_duration 
    from (
      select member_id,term_id, duration
      from qyy_mid_online.user_term_learn_duration 
      where day ="2017-01-01" and type = 'td' and tag='all_learn'
    ) t1 
    join (
      select id,provider_id from qyy_dbload_online.s2_term where day ='2017-10-23' and provider_id in (400000000029002,400000000008007,400000000030003,400000000030004,400000000042003,400000000043004,400000000052009,
            400000000054003,400000000055001,400000000056001,400000000062002,400000000070001,400000000071001,400000000073001,400000000073002,
            400000000074001,400000000075002,400000000078002,400000000078003,400000000082001,400000000087001,400000000090002,400000000090003,
            400000000096003,400000000096005,400000000101004,400000000037001,400000000106002,400000000108001,400000000110001,400000000115001,
            400000000114001,400000000112003,400000000114002,400000000115002,400000000116001,400000000116002,400000000125001,400000000134001,
...
(
    ...
    from (
      select member_id,term_id, duration
      from qyy_mid_online.user_term_learn_duration 
      where day ="2017-10-23" and type = 'td' and tag='all_learn'
    ) t1 
    join (
      select id,provider_id from qyy_dbload_online.s2_term where day ='2017-10-23' and provider_id in (400000000029002,400000000008007,400000000030003,400000000030004,400000000042003,400000000043004,400000000052009,
            400000000054003,400000000055001,400000000056001,400000000062002,400000000070001,400000000071001,400000000073001,400000000073002,
...
on (d1.provider_id = d3.provider_id)



select sum(2017_year_duration) as total_2017_duration
from(
select d1.provider_id, 
    d2.online_learn_duration as last_year_duration,
    d3.online_learn_duration as current_duration,
...
总线上学习时长： 491231027866 / 3600 / 1000 = 136453.0633 小时


select app_id, accurate_play_time from s2_live_content where gmt_create >= 1483200000000 and accurate_play_time <= 24*60*60*1000 and app_id in (400000000029002,400000000008007,400000000030003,400000000030004,400000000042003,400000000043004,400000000052009,
            400000000054003,400000000055001,400000000056001,400000000062002,400000000070001,400000000071001,400000000073001,400000000073002,
            400000000074001,400000000075002,400000000078002,400000000078003,400000000082001,400000000087001,400000000090002,400000000090003,
            400000000096003,400000000096005,400000000101004,400000000037001,400000000106002,400000000108001,400000000110001,400000000115001,
            400000000114001,400000000112003,400000000114002,400000000115002,400000000116001,400000000116002,400000000125001,400000000134001,
...
select sum(accurate_play_time)/(3600*1000) from s2_live_content where gmt_create >= 1483200000000 and accurate_play_time <= 24*60*60*1000 and app_id in (400000000029002,400000000008007,400000000030003,400000000030004,400000000042003,400000000043004,400000000052009,
            400000000054003,400000000055001,400000000056001,400000000062002,400000000070001,400000000071001,400000000073001,400000000073002,
            400000000074001,400000000075002,400000000078002,400000000078003,400000000082001,400000000087001,400000000090002,400000000090003,
            400000000096003,400000000096005,400000000101004,400000000037001,400000000106002,400000000108001,400000000110001,400000000115001,
            400000000114001,400000000112003,400000000114002,400000000115002,400000000116001,400000000116002,400000000125001,400000000134001,
